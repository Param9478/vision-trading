        ...
        <div className="flex flex-col items-center sm:flex-row sm:items-start sm:justify-between gap-8">
          ...
          <div className="text-center sm:items-start">
            ...
            <div className="flex justify-center space-x-6">
              ...
              <a
                href="https://t.me/tradewithscholar"
                target="_blank"
                className="text-gray-400 hover:text-teal-400 transition-colors"
              >
                ...
                <svg
                  ...
                  aria-hidden="true"
                >
                  <path d="M2 12l19-8-7 18-3.5-6.5L2 12z" />
                </svg>
              </a>
              <a
                href="https://youtube.com/@tradewithscholars?si=m_LqE9iyTpYfoOky"
                target="_blank"
                className="text-gray-400 hover:text-teal-400 transition-colors"
              >
